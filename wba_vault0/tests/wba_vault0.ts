...
describe('wba-vault0', () => {
  ...
  const programId = new PublicKey("Dq4UUdY4UBb6BiLRnRXBoF6xW7VZ9FKWNHZY94Zs4YmW");
  ...
  const vault = PublicKey.findProgramAddressSync([Buffer.from("vault"),state.toBuffer()],program.programId)[0];
